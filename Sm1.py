...
#========================================
            elif msg.text in ["bot01 backup run"]:
                if msg.from_ in admin:
                    ...
                    print r
                    print i
            elif msg.text in ["bot02 backup run"]:
                if msg.from_ in admin:
                    ...
                    print r
                    print i
            elif msg.text in ["bot03 backup run"]:
                if msg.from_ in admin:
                    ...
                    print r
                    print i
            elif msg.text in ["bot04 backup run"]:
                if msg.from_ in admin:
                    ...
                    print r
                    print i
            elif msg.text in ["bot05 backup run"]:
                if msg.from_ in admin:
                    ...
                    print r
                    print i
            elif msg.text in ["bot06 backup run"]:
                if msg.from_ in admin:
