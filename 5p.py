...
cl = LINETCR.LINE() #RADISTI
cl.login(token="EoLIri1fhNDOrRsJEyS4.ALqq0hix18OmztwW8q1aDa.N52OCWOJeNWCevW4LvmhiJW776IVzMeR+Qq0mWaUiNQ=")
cl.loginResult()

ki = LINETCR.LINE() #USSOW
ki.login(token="Eo8ml4kgVBqCN6xiwtAc.HAXaYczGV0xVj7BkGgemFa.s9CHWe09mVvsGe+oYpT++sxKLA+xaeNs3QkR0RI4/Hw=")
ki.loginResult()

kk = LINETCR.LINE() #SANJI
kk.login(token=" Eo25iUUpFtcSM1Nlp5y6.OsmTA4zIXh1LxjgYbUWI9G.98xQ18RrJfNMDEMy6+Ul+0rHwek7PbqQPKh8YXDIC1g=")
kk.loginResult()

kc = LINETCR.LINE() #KALANI
kc.login(token="EoEn5rjls1wIsEFby57a.DHeHozIH2dDZH7qBMF5JwG.NkF00Qa3Wkgfy3gWhpiJgSrW1w66IYqc8hoZ55nQoY4=")
kc.loginResult()

ks = LINETCR.LINE() #ZAKIYA
ks.login(token="EoqtuH5IjWZa6rMbSowd.nklCz8zx3nMDjSP4IRl1Fq.0gzS9w9CbKeANGJgiBpIkZizV0MjfhU6AYbnUcdhPes=")
ks.loginResult()

print "RADISTI TEAM login success"
reload(sys)
sys.setdefaultencoding('utf-8')

helpMessage ="""O҉n҉e҉ ҉P҉i҉e҉c҉e҉ ҉T҉e҉a҉m҉ ҉P҉r҉o҉t҉e҉c҉t҉
Owner : 👑1DAffaN3Kalalani👑
=======================
◄]·♦·Menu For Public·♦·[►
[•]Adminlist
[•]Ownerlist
...
Bots=[mid,Amid,Bmid,Cmid,Dmid,"ud7a8fbcc2af037c2c5bf181b89fda5f7"]
admin=["ud7a8fbcc2af037c2c5bf181b89fda5f7"] 
owner=["ud7a8fbcc2af037c2c5bf181b89fda5f7"]
wait = {
    'contact':False,
    'autoJoin':True,
...
CONTACT:
Idline: http://line.me/ti/p/H2VZm0LFeR~1DaffaN3Kalani""",
    "lang":"JP",
...
#--------------------------------
            ...
            if msg.contentType == 13:
               if wait["wblack"] == True:
                   ...
                   if msg.contentMetadata["mid"] in wait["blacklist"]:
                        ...
                        wait["dblacklist"] = False
                        cl.sendText(msg.to,"It is not in the blacklis")
    ...
    #-----------------=Selesai=------------------
            ...
            elif msg.text in ["Close","Close qr"]:
              if msg.from_ in admin:
                if msg.toType == 2:
                    X = random.choice(KAC).getGroup(msg.to)
...
#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
            elif msg.text in ["Oyyy","Radisti Assist","Come Bot"]: #Panggil Semua Bot
              if msg.from_ in owner:
    ...
    #-------------Fungsi Leave Group Start---------------#
            elif msg.text in ["Bye Bye","Bye All Bot"]: #Bot Ninggalin Group termasuk Bot Induk
              if msg.from_ in admin:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
            ...
            elif msg.text in ["Bye Assist","Bye Radisti Assist"]: #Semua Bot Ninggalin Group Kecuali Bot Induk
              if msg.from_ in admin:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
    ...
    #-------------Fungsi Tag All Start---------------#
            elif msg.text in ["Mention","Tagall","Woyyy","Assalamualaikum"]:
            	 if msg.from_ in admin:
    ...
    #-------------Fungsi Tag All Finish---------------#
      ...
      #--------------List Group------------
       #------------ Keluar Dari Semua Group------
            elif msg.text in ["Bot All Out","Radisti All Out"]: # Keluar Dari Semua Group Yang Di dalem nya  ada bot(Kalo Bot Kalian Nyangkut di Group lain :D)
              if msg.from_ in owner:
                gid = cl.getGroupIdsJoined()
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
            elif msg.text in ["Bot Absen","Team Absen","Radisti Absen"]:
              if msg.from_ in admin:
                cl.sendText(msg.to,"Tukang Bakul Brambang Taiwan Already ON")
                ki.sendText(msg.to,"Tukang Skandal Laler ijo Already ON")
                kk.sendText(msg.to,"Tukang ES CINCAU pasar Maling Already On")
                kc.sendText(msg.to,"Tukang Becak ODONG-ODONG ON")
                ks.sendText(msg.to,"Tukang Angon wedus ngaret Suket Already ON")
                cl.sendText(msg.to,"Semua Udah Hadir Boss\nSiap Protect Group\nAman Gak Aman Yang Penting Anu,piker Keri Bos Sambi Ngopi")
      ...
      #-------------Fungsi Banned Send Contact Finish------------------#
              ...
              cl.sendMessage(msg)
              cl.sendText(msg.to,"👆👆👆👆👆👆👆👆👆👆👆👆")
              cl.sendText(msg.to,"Itu Creator kami yang tidak sombong tidak suka selingkuh,tp mau kalo diajak selingkuh Syarat Ceraikan suami😜😜")
...
#-----------------------------------------------
        ...
        if op.type == 17:
          ...
          random.choice(KAC).sendText(op.param1,"Budayakan Baca Note !!! yah Ka 😊\nSemoga Betah Kakak dilarang nikung Salam cipokk😘😘😘")
          print "MEMBER HAS JOIN THE GROUP"
        if op.type == 15:
          if op.param2 in Bots:
             return
          random.choice(KAC).sendText(op.param1, "Innalilahiwainalilahi rojiun,Baper Tuh Orang,ingat DUMAY COYY:v ")
