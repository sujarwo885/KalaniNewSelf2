...
cl = LINETCR.LINE()
cl.login(token="EoCN4AzMBOS5VqcHTkUc.A1+5xln6MF94qu7Ic+Pu3a.oMMHgx2HKkzfUb2IXHdWA8gjAX7Dq/uZBGflRX09KcM=")
cl.loginResult()

kt = LINETCR.LINE()
kt.login(token="EoDvyOxFvEwF8SFQ25Ca.bDQP7xblQtYo/hfeBJ8dUG.EHaUXa9v4YdqeIFbIFXe5vLikibtwbPxnzCgGlW0EZI=")
kt.loginResult()
...
kl = LINETCR.LINE()
kl.login(token="EoqtuH5IjWZa6rMbSowd.nklCz8zx3nMDjSP4IRl1Fq.0gzS9w9CbKeANGJgiBpIkZizV0MjfhU6AYbnUcdhPes=")
kl.loginResult()
...
╠ 
╠ Creator by : SQUAD RANGERS BOTS TEAM
╠ Link : 
╠ 
╚═══════════════════
"""
...
autoleaveroom = []
targets = []
Bots=[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,"u577d79f51412f92e7a28d360ca351ae4"]
...
wait = {
    ...
    "lang":"JP",
    "comment":"AutoLike by Rangers-тєαм",
