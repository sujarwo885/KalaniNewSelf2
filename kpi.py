...
║
║════════════════════
║____[★]Rangers Bots Team★]____
╚════════════════════"""

About = """╔═════════════
║Rangers Bots Team Version 10.1║
╚═════════════"""
...
#-----------------------------------------------
    ...
    #-------------Fungsi Bannlist Finish------------------#  
              ...
              if msg.from_ in owner:
                  ...
                  if targets == []:
                      sendMessage(msg.to,"user does 1341209950exist")
                      pass
                  else:
                      for target in targets:
                          try:
    ...
    for zx in range(0,50):
      ...
      if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
        try:
          ...
          satpam.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉Auto Like Rangers bots team")
