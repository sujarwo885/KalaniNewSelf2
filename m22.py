...
#tinkerbell
cl = LINETCR.LINE()
cl.login(token="EoDvyOxFvEwF8SFQ25Ca.bDQP7xblQtYo/hfeBJ8dUG.EHaUXa9v4YdqeIFbIFXe5vLikibtwbPxnzCgGlW0EZI=")
cl.loginResult()
#vidia
kt = LINETCR.LINE()
kt.login(token="EoLIri1fhNDOrRsJEyS4.ALqq0hix18OmztwW8q1aDa.N52OCWOJeNWCevW4LvmhiJW776IVzMeR+Qq0mWaUiNQ=")
kt.loginResult()
#rosetta
ks = LINETCR.LINE()
...
#sirvelmist
ki = LINETCR.LINE()
ki.login(token=" Eo25iUUpFtcSM1Nlp5y6.OsmTA4zIXh1LxjgYbUWI9G.98xQ18RrJfNMDEMy6+Ul+0rHwek7PbqQPKh8YXDIC1g=")
ki.loginResult()
#fawn
#kk = LINETCR.LINE()
...
#kicker ghost1
kl1 = LINETCR.LINE()
kl1.login(token="EoqtuH5IjWZa6rMbSowd.nklCz8zx3nMDjSP4IRl1Fq.0gzS9w9CbKeANGJgiBpIkZizV0MjfhU6AYbnUcdhPes=")
kl1.loginResult()
#kicker ghost2
kl2 = LINETCR.LINE()
kl2.login(token="EoEn5rjls1wIsEFby57a.DHeHozIH2dDZH7qBMF5JwG.NkF00Qa3Wkgfy3gWhpiJgSrW1w66IYqc8hoZ55nQoY4=")
kl2.loginResult()
...
autoleaveroom = []
targets = []
Bots=[mid,Amid,Bmid,Cmid,Fmid,Gmid,Hmid]
admin = ["u577d79f51412f92e7a28d360ca351ae4",mid,Amid,Bmid,Cmid,Fmid,Gmid,Hmid]
               ...
               if msg.from_ in admin:
                ...
                for target in targets:
                   try:
                       ...
                       kl1.sendText(msg.to,"Done See U :*")
               ...
               if msg.from_ in admin:
                ...
                for target in targets:
                   try:
                       ...
                       kl2.sendText(msg.to,"Done See U :*")
...
#------------------------------------------------------------------------------------
        if op.type == 32:
			OWN = mid,Amid,Bmid,Cmid,Fmid,Gmid,Hmid
			if op.param2 in Bots and admin:
				pass
			else:
				Inviter = op.param3.replace("",',')
