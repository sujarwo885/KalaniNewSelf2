...
ks = LINETCR.LINE()
ks.login(token="EoAmUMZlV3uhA0xNNyE2.6qP7wxDr/icxSov6HIJlOG.K7QEFRz1Y5ScOmxsZa+j+JoN2V/vbiFAc2RezETXHIk=")
ks.loginResult()

kr = LINETCR.LINE()
kr.login(token="EoTUe154av5OvcsXYsp2.dgYWt8es393tPMWTlHCRaG.n2ySI4yuzFq0g/o8Mu4o+ZSyXx2zAUrIYOuith9SpDA=")
kr.loginResult()
...
administrator = ["udb6e3b128762959d3828bcf0778b7bf0"]
            ...
            #         gs = cl.getGroup(msg.to)
             ...
             #            cl.sendText(msg.to,"Not found")
              #       else:
				...
				OWN = "u603070a3aae2d0bc5607909a6a53a617"
				if msg.from_ in OWN:
					pass
				else:
				...
				OWN = "u5cffdfffde79ce3e76f9dfc9a6c34986"
				if msg.from_ in OWN:
					pass
				else:
            ...
            try:
                if op.param3 in mid:
                    ...
                    if op.param1 in protection:
                        OWN = "udb6e3b128762959d3828bcf0778b7bf0","u603070a3aae2d0bc5607909a6a53a617","u5cffdfffde79ce3e76f9dfc9a6c34986","ue90a7b597751f88097b0e57a8628cba2","u0c6cb04fc112dfddd3a66c2d2e172b02"
                    if op.param2 in OWN:
